...
\end{align}
Repeat for the second integral on the LHS of \eqt{eq:hc_qoi_derivation1}. We get:
\begin{align}
...
Subtract \eqt{eq:hc_qoi_derivation2} and \eqt{eq:hc_qoi_derivation3} to get the LHS of \eqt{eq:hc_qoi_derivation1}. Re-arrange the result to have:
\be
\int_a^b q \phi dx - J
=
