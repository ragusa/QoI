...
r = lambda t, u: u**2 # negative derivative of u*
q = lambda t, u: t**2 # derivative function of u

iters = 10000 # Number of steps to take
...
for i in range(iters-2, -1, -1):
	us[i] =  us[i+1] + h/2 * (r(t(i+1),u[i+1]) + r(t(i), u[i]))
